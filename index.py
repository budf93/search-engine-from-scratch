...
class InvertedIndexReader(InvertedIndex):
    ...
    def __next__(self):
        ...
        # Sekarang tuple-nya ada 5 elemen (ditambah upper_bound)
        metadata = self.postings_dict[curr_term]
        pos = metadata[0]
        len_in_bytes_of_postings = metadata[2]
        len_in_bytes_of_tf = metadata[3]
...
class InvertedIndexWriter(InvertedIndex):
    ...
    def append(self, term, postings_list, tf_list, upper_bound = 0.0):
        ...
        upper_bound: float
            Skor kontribusi maksimum dari term ini terhadap dokumen mana pun (untuk WAND)
        """
        ...
        # Simpan metadata termasuk upper_bound
